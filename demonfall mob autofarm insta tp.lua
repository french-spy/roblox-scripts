				...
				if closest:FindFirstChild("Down") then
					...
					repeat wait()
						...
						if lp.Character:FindFirstChild("OnExecute") or closest:FindFirstChild("Executing") then
							...
							local count2 = 0;
							repeat wait() lp.Character.HumanoidRootPart.Anchored = false; lp.Character.HumanoidRootPart.CFrame = cf * CFrame.new(0, -15, 0); count2 = count2 + 1; until closest:FindFirstChild("Executed") or lp.Character:FindFirstChild("ExecuteCooldown") or count2 >= 100;	
						end
